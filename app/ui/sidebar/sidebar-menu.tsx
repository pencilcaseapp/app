    ...
    <>
      <motion.div
        ...
        className={classNames([
          'fixed flex max-w-70 sm:max-w-62.5 pointer-events-auto overscroll-y-contain z-20 overflow-hidden w-full pt-14 h-dvh bg-pca-white dark:bg-pca-grey-900',
      ...
      >
        <nav className="top-0 left-0 h-[100dvh-56px] flex justify-between flex-col w-full max-w-70 sm:max-w-62.5 overflow-hidden overscroll-y-none overflow-x-hidden">
