          ...
          <Drawer.Viewport {...dialogViewportProps} className="fixed inset-0 flex items-end justify-center touch-none [--bleed:3rem] after:pointer-events-none after:fixed after:inset-x-0 after:bottom-0 after:h-(--bleed) after:bg-white after:content-[''] data-closed:after:opacity-0 has-data-swiping:after:opacity-0 dark:after:bg-pca-grey-900">
            <Drawer.Popup
              ...
              className={classNames(
                ...
                'after:pointer-events-none after:absolute after:inset-0 after:rounded-[inherit] after:bg-transparent after:content-[\'\'] after:transition-[background-color] after:duration-450 after:ease-[cubic-bezier(0.32,0.72,0,1)]',
                ...
                isFullHeight && 'min-h-[calc(95dvh+var(--bleed))] data-nested-drawer-open:min-h-0',
            ...
            >
              ...
              <Drawer.Content {...drawerContentProps} className={classNames('min-h-0 flex-1 overflow-y-auto overscroll-contain touch-auto px-4 pt-4 pb-6 transition-opacity duration-300', nestedFadeClassName)}>
                {children}
              </Drawer.Content>
              {footerArea && (
